...
# 使用示例
'''
python test_pth_AFLW2000.py  --batch_size 256 \
                --snapshot output/snapshots/SixDRepNet_1676215786_bs256MSE/_epoch_80.pth \
                --show_viz True
或
python test_pth_AFLW2000.py  --batch_size 256 \
                --dataset AFLW2000 \
                ...
                --show_viz False
'''
# 以上第二段示例代码最后一个参数可能会被解析为字符串，导致bool的False变字符串“False”
# 结果就是show_viz被解析成True
...
if __name__ == '__main__':
    ...
    #     model.load_state_dict(saved_state_dict['model_state_dict'], False)
    # else:
    #     # model.load_state_dict(saved_state_dict)
    #     model.load_state_dict(saved_state_dict['model'])
    # model.load_state_dict(saved_state_dict)
    # 以下是我个人的版本，直接保存model而非像原文件中那样保存几个字典
    # 发现这样做竟然精度得到了提高，用原始的tar（80个epoch）得到的MAE是17左右
    # 用现在的model得到的epoch1的MAE就到了4.8左右
